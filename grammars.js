...
grammarVar={
	...
	pubNameNoun:["Arms","Head","Lord","Lady","Plough","Raven","Dog","King","Queen"],
	pubNameNounSpace:["Sprocket","Oil","Rock","Moon","Dust","Monarch","Emporer","Abyss"],
	pub:["pub","bar"],
	pubName:["#pubNameNounSpace#'s #pubNameNoun#","#pubNameNoun#'s #pubNameNounSpace#","#pubNameNounSpace# and #pubNameNoun#","#pubNameNounSpace# and #pubNameNounSpace#","#pubNameNoun# and #pubNameNounSpace#","#pubNameAdj# #pubNameNounSpace#","#pubNameAdjSpace# #pubNameNoun#"],
	color:["red","blue"],
	physicalAdj:["#color#","old","strong","wizened"],
	otherAdj:["creepy","mysterious"],
	emotionalAdj:["jovial","angry","well mannered","wistful"],
	someoneAdj:["#emotionalAdj#","#physicalAdj#","#otherAdj#"],
	job:["detective","vendor","pilot","#shooter#","#engi#"],
